...
raw_tweets = LOAD '/user/okmich20/output/handson_train/flume/techJobTweet/2017/04/22/07' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') as (json:map[]);
