...
raw_tweets = LOAD '/user/cloudera/output/handsontrain/august/flume/twitter_harvey/2017/08/26/07' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') as (json:map[]);
