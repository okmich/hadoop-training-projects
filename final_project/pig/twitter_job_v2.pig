...
raw_tweets = LOAD '${techJobTweetHDFSPrefix}/${year}/${month}/${day}/${hour}' USING com.twitter.elephantbird.pig.load.JsonLoader('-nestedLoad') as (json:map[]);
...
STORE dsnt_tweets INTO '${techTweetPigOutputPrefix}/${year}/${month}/${day}/${hour}' USING AvroStorage();
