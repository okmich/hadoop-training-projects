raw_data = LOAD '/user/cloudera/rawdata/handson_train/airline_performance/flights' USING PigStorage(',') AS 
...
STORE rel_data INTO '/user/cloudera/output/handson_train/pig/airline_time_performance/refactored' Using PigStorage(',');